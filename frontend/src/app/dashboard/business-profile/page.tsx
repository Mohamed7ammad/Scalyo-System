...
export default function BusinessProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6" dir="rtl">
      ...
      {/* ── Page header ──────────────────────────────────────────── */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">بروفايل البيزنس</h1>
        <p className="text-sm text-gray-500 mt-1">معلومات البراند والإعدادات الأساسية</p>
      </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-2 space-y-5">
            ...
            {!isAdmin && (
              <div className="flex items-center gap-3 bg-amber-50 border border-amber-200
                text-amber-800 rounded-xl px-4 py-3 text-sm">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm">
              <div className="px-6 py-5 border-b border-gray-100">
                <h2 className="text-base font-semibold text-gray-800">معلومات البراند</h2>
                  ...
                  <div key={key}>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2.5 border rounded-xl text-sm outline-none transition
                        ${isAdmin
                          ? 'border-gray-300 focus:ring-2 focus:ring-indigo-400 focus:border-transparent bg-white'
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
              <h2 className="text-sm font-semibold text-gray-700 mb-4">معاينة البراند</h2>
              ...
              <div className="flex flex-col items-center gap-4">
                {logoUrl ? (
                  ...
                  <img
                    src={logoUrl}
                    alt="شعار البراند"
                    className="w-24 h-24 object-contain rounded-2xl border border-gray-200 bg-gray-50 p-2"
                ...
                <div className="text-center">
                  ...
                  {(draft.industry ?? '').trim() && (
                    <span className="inline-block mt-1 px-3 py-0.5 bg-indigo-50 text-indigo-600
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-4 text-sm text-indigo-700">
              ...
              <p className="text-indigo-600 leading-relaxed text-xs">
